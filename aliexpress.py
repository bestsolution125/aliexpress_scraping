...
time.sleep(2)
driver.execute_script("window.scrollTo(1600, 1800);")
time.sleep(2)
driver.execute_script("window.scrollTo(1800, 2000);")
time.sleep(2)
driver.execute_script("window.scrollTo(2000, 2200);")
time.sleep(2)
driver.execute_script("window.scrollTo(2200, 2400);")
time.sleep(2)
driver.execute_script("window.scrollTo(2400, 2600);")
time.sleep(2)
driver.execute_script("window.scrollTo(2600, 2800);")
time.sleep(2)
driver.execute_script("window.scrollTo(2800, 3000);")
time.sleep(2)
driver.execute_script("window.scrollTo(3000, 3200);")
time.sleep(2)
driver.execute_script("window.scrollTo(3200, 3400);")
time.sleep(2)
driver.execute_script("window.scrollTo(3400, 3600);")
time.sleep(2)
driver.execute_script("window.scrollTo(3600, 3800);")
time.sleep(2)
